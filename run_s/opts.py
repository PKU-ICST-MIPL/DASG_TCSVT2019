...
def parse_opt():
    ...
    parser.add_argument('--model_name', type=str, default='UDAG')
    parser.add_argument('--data_path', default='/data2/chijingze/UDAG', help='path to datasets')
    parser.add_argument('--data_name', default='flickr', help='{coco,f8k,f30k,10crop}_precomp|coco|f8k|f30k')
    ...
    parser.add_argument('--n_classes_obj', default=151, type=int, help='Class number of objects.')
    parser.add_argument('--n_classes_pred', default=51, type=int, help='Class number of pred.')
    ...
    parser.add_argument('--bi_gru', action='store_true',help='Use bidirectional GRU.')
    ...
    parser.add_argument('--embed_size', default=300, type=int, help='Dimensionality of the joint embedding.')
    ...
    parser.add_argument('--logger_name', default='runs/log', help='Path to save the model and Tensorboard log.')
    parser.add_argument('--resume', default='runs/log_UDAG/model_best.pth.tar', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
    parser.add_argument('--max_violation', action='store_true', help='Use max instead of sum in the rank loss.')
    parser.add_argument('--img_dim', default=1024, type=int, help='Dimensionality of the image embedding.')
    parser.add_argument('--text_dim', default=300, type=int, help='Dimensionality of the image embedding.')
