...
def i2t_bak(images, captions, npts=None, measure='cosine', return_ranks=False):
    """
    ...
    d_ret = np.zeros((len(images)/ 5, len(captions)))
    ...
    if return_ranks:
        ...
        return (r1, r5, r10, medr, meanr), d


def t2i_bak(images, captions, npts=None, measure='cosine', return_ranks=False):
    """
    ...
    d_ret = np.zeros((len(npts), len(captions)))
    for index in range(npts):
...
def i2t(images, captions, npts=None, measure='cosine', return_ranks=False):
    ...
    if return_ranks:
        ...
        return (r1, r5, r10, medr, meanr), d_ret
...
def t2i(images, captions, npts=None, measure='cosine', return_ranks=False):
    ...
    d_ret = np.zeros((len(captions),len(images)/5))
    for index in range(npts):
